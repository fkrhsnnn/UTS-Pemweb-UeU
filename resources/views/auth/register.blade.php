            ...
            <div class="col-12">
                <div class="card shadow mt-5">
                    <div class="card-body text-center">
                        <h1 class="mb-5">Register Admin</h1>
                        @if (session('error'))
                        ...
                        <form method="POST" action="{{ route('register.store') }}">
                            ...
                            <div class="d-grid gap-2 mt-3 col-6 mx-auto">
                                <button type="submit" class="btn btn-success btn-lg mt-2">Register</button>
                            </div>

                            <div class="d-grid gap col-6 mx-auto mt-3">
                                <a href="{{ route('login') }}" class="fw-bold">Already have account? Login</a>
                            </div>
                        </form>
                    </div>
                </div>
